...
const formFields = [
  ...
  {
    label: "Where are you located at?",
    name: "location",
    type: "text",
  ...
  {
    label: "For what purpose does this PC serve you?",
    name: "purpose",
    type: "text",
    placeholder: "E.g. Video Editing, Gaming etc.",
  },
  {
  ...
  return (
    <div className="d-flex flex-column justify-content-center align-items-center bg-black">
      <form
        ...
        className="p-4 mt-5 mb-5 bg-white rounded shadow"
